...
namespace buttons{
	...
	static Button buttons[] = {
		...
		{.id=ButtonId::SW10, .pin=D0,  .hadPressedInterrupt=false, .pressedInterrupt = sw10_pressedInterrupt},
		...
		{.id=ButtonId::SW13, .pin=D1,  .hadPressedInterrupt=false, .pressedInterrupt = sw13_pressedInterrupt},
